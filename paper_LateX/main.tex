...
\begin{figure*}[ht]
\centering
\includegraphics[width=\linewidth]{imgs/allStructure.png}
...
\bibliography{references.bib,./references2.bib,SampleReferences.bib}
\end{document}
